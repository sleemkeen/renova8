		...
		<div class="row row-grid justify-content-between">
			<div class="col-lg-6 align-self-end">
				<div class="py-lg-lg text-center text-lg-left">
					<h2 class="heading h1 text-white mb-4">COMMERCIAL RENOVATIONS</h2>
					<p class="lead lh-180 text-white">
						We have built an outstanding pedigree in large and small business renovations, retail outlet renovations and other commercial spaces. Our commercial renovation services cover interior and exterior face-lifts that enhances the efficiency and functionality of your spaces.
					</p>
					<div class="mt-5">
			...
			<div class="col-lg-12">
				...
				<div class="mb-lg">
					<div class="row">
						...
						<div class="col-md-9">
							<h2 class="h2" style="text-transform: capitalize;">Interior walls, doors, and windows renovation</h2>
				...
				<div class="mb-lg">
					<div class="row">
						...
						<div class="col-md-9">
							<h2 class="h2" style="text-transform: capitalize;">ATM Galleries</h2>
							<p class="mt-3">Whether your package is Good, Better or Best, we can take care of sourcing and installing cost-effective and energy-efficient appliances and products in every kitchen we work on. This takes any pressure off you, ensuring everything works as it should and fits any new or existing cabinetry.</p>
						</div>
						<div class="col-md-3">
			...
			<div class="modal-body">
				...
				<div class="row">
					...
					<div class="col-md-12 mb-3">
						...
						<input type="hidden" name="type" value="Commercial Renovation">
