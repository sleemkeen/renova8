		...
		<div class="row row-grid justify-content-between">
			<div class="col-lg-6 align-self-end">
				<div class="py-lg-lg text-center text-lg-left">
					<h2 class="heading h1 text-white mb-4" style="text-transform: capitalize;">Architectural Designs &amp; 3D rendering</h2>
					<p class="lead lh-180 text-white">
						Our design reflects a building composed of a dateless contemporary form and interior, with our climate as
						the determinant of our building’s functionality. We also take into cognizance the reality of our everyday
						traditional domestic lifestyle and finally, minimally infuse interiors with ethnicity. Our beliefs are;
					</p>
					<div class="mt-5">
						<a href="#" class="btn btn-info btn-circle px-5 mr-lg-4" style="background-color: #0c427b; border:#0c427b">
						SEE OUR PACKAGES </a>
			...
			<div class="col-lg-12">
				<div class="mb-lg">
					<div class="row">
						...
						<div class="col-md-9">
							<h2 class="h2 mb-4" style="text-transform: capitalize;">Less walls more space</h2>
				...
				<div class="mb-lg">
					<div class="row">
						...
						<div class="col-md-9">
							<h2 class="h2" style="text-transform: capitalize;">Floor to ceiling window</h2>
				...
				<div class="mb-lg">
					<div class="row">
						...
						<div class="col-md-9">
							<h2 class="h2" style="text-transform: capitalize;">No visible roofs</h2>
				...
				<div class="mb-lg">
					<div class="row">
						...
						<div class="col-md-9">
							<h2 class="h2" style="text-transform: capitalize;">Internal ergonomics and functionality</h2>
							<p class="mt-3">Whether your package is Good, Better or Best, we can take care of sourcing and installing cost-effective and energy-efficient appliances and products in every kitchen we work on. This takes any pressure off you, ensuring everything works as it should and fits any new or existing cabinetry.</p>
						</div>
						<div class="col-md-3">
							<img alt="Image placeholder" src="{{asset('customdesign.png')}}" class="img-fluid">
			...
			<div class="modal-body">
				...
				<div class="row">
					...
					<div class="col-md-12 mb-3">
						...
						<input type="hidden" name="type" value="Architectural Designs">
